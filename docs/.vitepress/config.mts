  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: "Contributing", link: "/contributing/" },
      {
        text: "API",
        items: [
          // The API references are HTML bundles generated by TypeDoc / rustdoc,
          // not VitePress-routed pages. Open them in a new tab so the VitePress
          // SPA router never tries (and fails) to handle them — clicking the
          // link used to render a blank page, hard-refresh would jump into the
          // TypeDoc/rustdoc shell, and Back was unable to return.
          {
            text: "TypeScript / JS",
            link: "/api/ts/",
            target: "_blank",
